...
src/
  ...
  components/    — Astro/React components, one subfolder per component
                   ...
                   ShiftLog, ShiftToggle, ReadingRoom, OffTrail); barrel
                   src/components/index.ts is auto-generated (see §4)
  ...
  lib/           — readers for each Keystatic collection (experience, skills,
                   ...
                   see §6a), metric-countup, utils (the cn helper)
...
scripts/         — build hooks (gen-barrels.ts, gen-trail-register.ts,
                   gen-shift-log.ts) and local-LLM / session tooling
