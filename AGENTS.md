...
| Visual output changes | Follow the approval policy: Chromatic is the blocking gate, approve deliberate diffs in its UI; local baselines reseed only after visual review of every diff | Required `chromatic` check (dedicated job, fails closed) + `docs/decisions/2026-07-10-visual-approval-policy.md` |
